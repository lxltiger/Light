...
public class LightCommandUtils {
    ...
    public static void addAlarm(boolean on ,int address,int hour,int min) {
...
// 0x91 week 开  0x90 week 关
        params[offset++] =on?(byte) 0x91:(byte) 0x90;
        params[offset++] = (byte) (instance.get(Calendar.MONTH) + 1);
//        params[offset++] = (byte) instance.get(Calendar.DAY_OF_MONTH);
        params[offset++] = 0x7f;
        params[offset++] = (byte)hour/* instance.get(Calendar.HOUR_OF_DAY)*/;
        params[offset++] = (byte)min /*instance.get(Calendar.MINUTE)*/;
        params[offset++] = (byte)0 /*instance.get(Calendar.SECOND)*/;
        params[offset++] = 0x00;
